      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.hasError) {
            return const Center(child: Text("Za sada nema porudzbina"));
          }
          ...
          return ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              if (orderData['orderDate'] != null) {
                date = (orderData['orderDate'] as Timestamp).toDate();
              } else {
                date =
                    DateTime.now(); 
              }
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  title: Text(
                    "Porudžbina: #${orderData['orderId'].toString().substring(0, 2)}",
                  ...
                  subtitle: Column(
                    ...
                    children: [
                      ...
                      Text(
                        "Dostava na: ${orderData['userAddress'] ?? orderData['address']}",
                      ),
                    ],
                  ),
                  trailing: Text(
